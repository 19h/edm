...
impl Ratio {
    ...
    pub fn new(credits: Credits, millis: Millis) -> Self {
        ...
        Self {
            credits: credits.0 / divisor,
            millis: millis.0 / divisor,
        }
    }
...
mod tests {
    ...
    fn ratios_compare_exactly_where_a_quotient_would_tie() {
        ...
        let a = Ratio {
            credits: 1_000_000_000_000_000_001,
            millis: 1_000_000_000_000_000_000,
        };
        let b = Ratio {
            credits: 1_000_000_000_000_000_002,
            millis: 1_000_000_000_000_000_000,
        };
        assert!(a < b);
    }
    ...
    fn equal_rates_in_different_terms_are_equal() {
        ...
        assert_eq!(
            Ratio::new(Credits(50), Millis(100)),
            Ratio {
                credits: 1,
                millis: 2
            }
